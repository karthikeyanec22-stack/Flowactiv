...
export default function Features() {
  return (
    <section className="scroll-mt-20 relative w-full min-h-[200px] sm:min-h-[420px] bg-[#f8fafc] dark:bg-[#090b14] flex items-center justify-center overflow-hidden py-6 sm:py-10 transition-colors duration-500">
