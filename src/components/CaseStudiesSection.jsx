...
export default function CaseStudiesSection() {
  ...
  return (
    <section
      id="case-studies"
      className="scroll-mt-16 sm:scroll-mt-20 pt-6 sm:pt-10 pb-16 sm:pb-24 relative w-full bg-[#f8fafc] dark:bg-[#02050e] text-slate-950 dark:text-white overflow-hidden transition-colors duration-500"
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          {/* Main Title (1:1 Reference Match) */}
        ...
        {/* HUB & CIRCULATION STAGE WITH CENTRAL CRYSTAL DIAMOND NODE */}
        <div className="relative w-full py-6 sm:py-10 flex flex-col items-center justify-center">

          {/* BACKGROUND DIAGONAL LASER CONNECTOR LINES (SVG 1:1 MATCH) */}
          ...
          <div className="absolute top-[45%] left-1/2 -translate-x-1/2 -translate-y-1/2 z-30 hidden md:block">
            ...
            >
              ...
              {/* 3D Crystal Prism Hexagon Frame */}
              <div className="relative w-full h-full bg-gradient-to-tr from-cyan-300 via-purple-400 to-indigo-600 rounded-3xl p-1.5 shadow-2xl [clip-path:polygon(50%_0%,100%_25%,100%_75%,50%_100%,0%_75%,0%_25%)] flex items-center justify-center">
          ...
          {/* 2x2 HEXAGON CARDS GRID LAYOUT (1:1 REFERENCE MATCH) */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 w-full max-w-5xl mx-auto relative z-10">
            {caseStudies.map((item, idx) => (
              ...
              >
                {/* 1. OUTER HEXAGON GLASS BACKING PLATE (1:1 REFERENCE MATCH) */}
                <div className="relative w-full aspect-[4/3.2] max-w-md p-1 bg-gradient-to-tr from-purple-600/40 via-cyan-400/30 to-indigo-600/40 group-hover:from-purple-500 group-hover:to-cyan-300 shadow-2xl backdrop-blur-xl [clip-path:polygon(50%_0%,100%_25%,100%_75%,50%_100%,0%_75%,0%_25%)] flex items-center justify-center">

                  {/* Inner Dark Hexagon Surface */}
                  <div className="w-full h-full bg-gradient-to-br from-[#121638] via-[#090d26] to-[#1c123d] [clip-path:polygon(50%_0%,100%_25%,100%_75%,50%_100%,0%_75%,0%_25%)] flex items-center justify-center p-4 sm:p-6 relative overflow-hidden">
                    ...
                    {/* 2. INNER SMARTPHONE / SCREEN PREVIEW MOCKUP (1:1 REFERENCE MATCH) */}
                    <div className="relative w-[78%] h-[92%] rounded-[24px] sm:rounded-[28px] overflow-hidden border-2 border-slate-900/90 dark:border-purple-400/50 shadow-2xl bg-slate-950 flex flex-col justify-between z-10">
                      {item.imageSrc ? (
                        <Image
                          src={item.imageSrc}
                          alt={item.title}
                      ...
                      {/* Bottom Floating Circular Arrow Button (1:1 REFERENCE MATCH) */}
